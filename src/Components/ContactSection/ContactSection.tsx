...
export default function ContactSection() {
  return (
    <div className="contact-section relative flex flex-col items-center justify-center bg-lightred">
      <h1 className="contact-section__title w-70v mt-24 mb-4 text-center text-32 leading-8 font-livvic font-bold text-darkergreen">
        Ready to get started?
      </h1>
      <button className="contact-section__button mb-24 border-darkergreen border-2 rounded-3xl py-1.5 px-8 text-lg text-darkergreen font-livvic font-bold">
        contact us
      </button>
      <svg
        className="contact__patter absolute -bottom-5 left-0"

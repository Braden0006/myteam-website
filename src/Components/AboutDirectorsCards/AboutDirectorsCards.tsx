  ...
  return (
    <div className="w-90v mt-12 md:grid md:grid-cols-2 md:gap-4 md:w-80v lg:grid-cols-3">
      <div className="relative flex flex-col items-center justify-center mb-14 bg-darkergreen">
        ...
        {nikita ? (
          <span
            className="absolute -bottom-7 flex justify-center items-center h-14 w-14 bg-cyan rounded-full z-10"
          ...
          <span
            className="absolute -bottom-7 flex justify-center items-center h-14 w-14 bg-lightred rounded-full z-10"
      ...
      <div className="relative flex flex-col items-center justify-center mb-14 bg-darkergreen">
        ...
        <span className="absolute -bottom-7 flex justify-center items-center h-14 w-14 bg-lightred rounded-full z-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            <path
              fill="#012F34"
              fillRule="evenodd"

...
export default function Homepage() {
  ...
  return (
    <div className="flex items-center justify-center bg-primary relative h-screen">
      ...
      {isDesktop && (
        <svg
          className="absolute -left-32 xl:-left-100px"
      ...
      <div className="flex flex-col items-center w-screen text-center mb-8 lg:flex-row lg:w-80v lg:items-start lg:gap-12 lg:h-25v">
        <div className="lg:flex lg:w-50% lg:h-full lg:items-end">
          <h1 className="text-white text-4xl mb-5 w-55v font-livvic font-bold md:text-64 md:leading-16 md:w-50v md:mb-8 lg:text-left lg:w-full lg:mb-0 lg:text-7xl lg:leading-16 xl:text-100 xl:leading-24">
            Find the best{" "}
            <span className="homepage__title__word text-lightred">talent</span>
          </h1>
        </div>

        <div className="flex flex-col items-center justify-center lg:w-50% lg:h-full lg:justify-between lg:items-start xl:pl-32">
          {isDesktop && (
            <svg
              width="50"
              height="4"

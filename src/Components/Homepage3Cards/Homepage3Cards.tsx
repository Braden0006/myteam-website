  ...
  return (
    <>
      <div className="homepage3Cards__card relative flex flex-col items-center justify-center">
        ...
        <p className="homepage3Cards__title w-85v mt-8 text-center z-10 font-livvic text-white lg:w-auto">
          {" "}
      ...
      <div className="homepage3Cards__card relative flex flex-col items-center justify-center mb-28 md:mb-16 lg:mb-0">
        <svg
          className="homepage3Cards__card__pattern absolute top-0"
          xmlns="http://www.w3.org/2000/svg"
          width="67"

...
export default function Contact() {
  ...
  return (
    <main className="relative flex flex-col items-center justify-center mt-36 md:mt-48 lg:grid lg:grid-cols-2 lg:w-80v lg:mb-36">
      <div className="lg:h-90% lg:flex lg:flex-col lg:justify-between">
        <h1 className=" mb-2 text-40 font-livvic font-bold text-white md:text-64">
          Contact
        </h1>
        <h2 className="text-32 font-livvic font-bold text-lightred">
          Ask about us
        </h2>
        <div className="md:w-65v lg:w-auto">
          <section className="flex items-center justify-around mt-10 w-90v md:w-auto md:justify-between">
            ...
            <p className="w-70% text-lg text-white font-livvic font-bold md:w-80%">
              The quality of our talent network
            </p>
          </section>
          <section className="flex items-center justify-around mt-8 w-90v md:w-auto md:justify-between">
          ...
          <section className="flex items-center justify-around mt-8 mb-12 w-90v md:w-auto md:justify-between">
            <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72">
              <g fill="none" fillRule="evenodd">
                <circle cx="44" cy="44" r="28" fill="#2C6269" />
                <path
      ...
      {isTablet && (
        <svg
          className="absolute -left-100px top-12 lg:-left-56 xl:-left-64"
      ...
      <svg
        className="absolute -bottom-28 -right-28 md:bottom-0 lg:-right-56 xl:-right-64"
        xmlns="http://www.w3.org/2000/svg"
        width="201"
        height="225"
      >
